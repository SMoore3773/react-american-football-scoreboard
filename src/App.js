    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={() => setCountH(countH + 7)}className="homeButtons__touchdown">Home Touchdown</button>
          <button onClick={() => setCountH(countH + 3)}className="homeButtons__fieldGoal">Home Field Goal</button>
        </div>
